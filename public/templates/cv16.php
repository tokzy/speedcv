...
<body>
<div class="wrapper row-vm">
<div class="resume">
<?php
$pdetails = $api->getpd($pid);
?>
<!-- TOP CONTAINER-->
<div class="container cv16-top">
<!-- user image and name-->
<div class="cv5-user cv16-user">
...
<div class="user-img disp-i-b m-r">
...
<div class="container cv5-left cv14-left general-info l-float">
<?php
$title2 = "Education";
