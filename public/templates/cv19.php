		...
		<div class="resume">
			<!-- TOP CONTAINER-->
				<div class=" container cv9-top cv19-top">
					<div >
						<!-- user image and name-->
						<div class=" cv9-user cv13-user cv19-user container">
							<!-- user image -->
							<div class="user-img">
					...
					<div class="info-text">
						<div class="cv9-social cv19-social ">
							<div class="opi-item">
								...
								<p class="disp-i-b">Account link</p>
							</div>
						...
						<div>
							...
							<div class="objective-info">
								<div class="cv5-extra-personal-info cv19-extra-personal-info">
									...
									<div class="opi-item cv5-opi-item">
										<p class="cv5-opi-item-title disp-i-b">Marital Status:</p>
