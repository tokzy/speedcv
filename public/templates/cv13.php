...
<div class="sp cv13-sp">
<?php if($skill['level'] == "1"):?>
<div class="sb cv13-sb w-20"></div>
<?php elseif($skill['level'] == "2"):?>
<div class="sb cv13-sb w-40"></div>
<?php elseif($skill['level'] == "3"):?>
<div class="sb cv13-sb w-60"></div>
<?php elseif($skill['level'] == "4"):?>
<div class="sb cv13-sb w-80"></div>
<?php elseif($skill['level'] == "5"):?>
<div class="sb cv13-sb w-100"></div>
<?php endif;?>	
</div>
</div>
<?php endforeach;?>
