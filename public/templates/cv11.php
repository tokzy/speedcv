...
<div class="opi-item cv4-opi-item ">
<p class="cv4-opi-item-title">Phone:</p>
...
<div class="opi-item cv4-opi-item ">
<p class="cv4-opi-item-title">Email:</p>
...
<div class="opi-item cv4-opi-item ">
<p class="cv4-opi-item-title">Address:</p>
...
<div class="opi-item cv4-opi-item ">
<p class="cv4-opi-item-title">Website:</p>
...
<div class="opi-item cv4-opi-item ">
<p class="cv4-opi-item-title">Date of Birth:</p>
...
<div class="opi-item cv4-opi-item ">
<p class="cv4-opi-item-title">Gender:</p>
...
<div class="opi-item cv4-opi-item ">
<p class="cv4-opi-item-title">Religion</p>
...
<h2 class="cv11-h2"><?php echo $obj['title'];?></h2>
</div>
<div class="info-text">
...
<div class="gi">
<div class="info-header cv11-info-header">
<h2 class="cv11-h2"><?php echo $obj3['title'];?></h2>
</div>
<div class="info-text">
<div class="skills-info cv11-skills-info">
<div class="row" style="padding-left:10px;">
...
<div class="gi">
<div class="info-header cv11-info-header">
<h2 class="cv11-h2"><?php echo $obj4['title'];?></h2>
</div>
...
<div class="gi">
<div class="info-header cv11-info-header">
<h2 class="cv11-h2"><?php echo $obj5['title'];?></h2>
</div>
...
<div class="gi">
<div class="info-header cv11-info-header">
<h2 class="cv11-h2"><?php echo $obj6['title'];?></h2>
</div>
...
<div class="gi">
<div class="info-header cv11-info-header">
<h2 class="cv11-h2"><?php echo $id['title'];?></h2>
</div>
<div class="info-text">
<div class="reference-info ">
<?php
