...
<body>
<div class="wrapper ">
<div class="resume cv10">
<?php
$pdetails = $api->getpd($pid);
?>
<!-- TOP CONTAINER-->
<div class="container cv9-top cv10-top">
...
<div class="container cv10-right general-info ">
<!--Personal Info -->
<div class="gi">
<div class="info-header cv4-info-header cv10-info-header">
...
<div class="info-text">
<div class="skills-info cv10-skills-info">
<div class="row" style="padding-left:10px;">
<?php foreach($skills as $skill):?>
<div class="column2">
<div class="skills-info-li">
<p class="skill-name"><?php echo $skill["skills"];?></p>
<div class="sp cv10-sp">
<?php if($skill['level'] == "1"):?>
<div class="sb cv10-sb w-20"></div>
<?php elseif($skill['level'] == "2"):?>
<div class="sb cv10-sb w-40"></div>
<?php elseif($skill['level'] == "3"):?>
<div class="sb cv10-sb w-60"></div>
<?php elseif($skill['level'] == "4"):?>
<div class="sb cv10-sb w-80"></div>
<?php elseif($skill['level'] == "5"):?>
<div class="sb cv10-sb w-100"></div>
<?php endif;?>	
</div>
</div>
</div>
...
<div class="gi">
<div class="info-text">
<div class="cv10-social ">
<?php if(empty($pdetails['linkedin'])):else:?>
<div class="opi-item">
<p class="opi-item-title cv8-opi-icon cv10-opi-icon"><img src="./img/linkedin-w.png"></p>
...
<div class="opi-item">
<p class="opi-item-title cv8-opi-icon cv10-opi-icon"><img src="./img/facebook-w.png"></p>
...
<div class="opi-item">
<p class="opi-item-title cv8-opi-icon cv10-opi-icon"><img src="./img/twitter-w.png"></p>
...
<div class="opi-item">
<p class="opi-item-title cv8-opi-icon cv10-opi-icon"><img src="./img/instagram-w.png"></p>
