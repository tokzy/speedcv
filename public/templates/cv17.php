...
?>
<!-- TOP CONTAINER-->
<div class="container cv8-top cv17-top">
<?php if(empty($pdetails['facebook']) && empty($pdetails['twitter']) && empty($pdetails['instagram']) && empty($pdetails['linkedin'])): else:?>
<!-- social  -->
<div class="cv8-opi  disp-i-b">
<div class="cv17-personal-info ">
<?php if(empty($pdetails['linkedin'])):else:?>
<div class="opi-item cv8-opi-item">
<p class="opi-item-title disp-i-b"><img src="./img/linkedin-w.png"></p>
...
<div class="opi-item cv8-opi-item ">
<p class="opi-item-title disp-i-b"><img src="./img/facebook-w.png"></p>
...
<div class="opi-item cv8-opi-item ">
<p class="opi-item-title disp-i-b"><img src="./img/twitter-w.png"></p>
...
<div class="opi-item cv8-opi-item ">
<p class="opi-item-title disp-i-b"><img src="./img/instagram-w.png"></p>
...
<p class="opi-item-title m-r"><img src="./img/android.png"></p>
...
<div class="opi-item cv9-opi-item">
<p class="opi-item-title m-r"><img src="./img/secured-letter-w.png"></p>
...
<div class="opi-item cv9-opi-item">
<p class="opi-item-title m-r"><img src="./img/user-location-w.png"></p>
...
<div class="opi-item cv9-opi-item">
<p class="opi-item-title m-r"><img src="./img/globe.png"></p>
...
<div class="container cv8-right general-info ">
<!--Personal Info -->
<div class="gi">
<div class="info-header cv4-info-header cv8-info-header">
...
<div class="info-text">
<div class="skills-info cv8-skills-info">
<div class="row" style="padding-left:10px;">
...
<div class="sb cv8-sb w-20"></div>
<?php elseif($skill['level'] == "2"):?>
<div class="sb cv8-sb w-40"></div>
<?php elseif($skill['level'] == "3"):?>
<div class="sb cv8-sb w-60"></div>
<?php elseif($skill['level'] == "4"):?>
<div class="sb cv8-sb w-80"></div>
<?php elseif($skill['level'] == "5"):?>
<div class="sb cv8-sb w-100"></div>
<?php endif;?>	
</div>
</div>
</div>
