...
<div class="container cv1-right cv18-right general-info l-float">
<?php
$title = "Objective";
...
<h2 class="bl"><?php echo $obj['title'];?></h2>
</div>
<div class="info-text">
...
<div class="gi">
<div class="info-header">
<h2 class="bl"><?php echo $obj2['title'];?></h2>
</div>
...
<div class="sp cv18-sp">
<?php if($skill['level'] == "1"):?>
<div class="sb cv18-sb w-20"></div>
<?php elseif($skill['level'] == "2"):?>
<div class="sb cv18-sb w-40"></div>
<?php elseif($skill['level'] == "3"):?>
<div class="sb cv18-sb w-60"></div>
<?php elseif($skill['level'] == "4"):?>
<div class="sb cv18-sb w-80"></div>
<?php elseif($skill['level'] == "5"):?>
<div class="sb cv18-sb w-100"></div>
<?php endif;?>	
</div>
</div>
</div>
...
<div class="container cv1-left cv18-left personal-info r-float">
<!-- user image and name-->
<div class="in">
